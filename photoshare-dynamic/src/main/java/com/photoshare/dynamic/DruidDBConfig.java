...
import com.photoshare.config.MybatisPlusConfig;
...
public class DruidDBConfig {
    ...
    @Value("${spring.datasource.dynamic.datasource.ykscrm.driver-class-name}")
...
//        datasource.setMaxWait(maxWait);
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:/mapper/*/xml/*Mapper.xml"));
