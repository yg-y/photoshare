...
public class DynamicRoutingDataSource extends AbstractRoutingDataSource {
    ...
    public void checkCreateDataSource(DatabaseList dataSource) {
        ...
        if (map.containsKey(code)) {
            ...
            DruidDataSource druidDataSource = (DruidDataSource) map.get(code);
            boolean flag = true;
     ...
     * @Description: 创建数据源
     */
    public void createDataSource(DatabaseList dataSource) {
        try {
            ...
            this.custom.put(dataSource.getCode(), druidDataSource);
